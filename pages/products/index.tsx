    ...
    return (
        <div className="flex h-full">
            <div ref={filtersMenuRef} className="relative h-full bg-gray-100">
                <button className={`rounded-full bg-gray-100 m-4 font-semibold ${isFiltersMenuOpen ? 'hidden' : 'block'}`} onClick={() => setIsFiltersMenuOpen(true)}>Filters</button>
            ...
            <div className="overflow-y-auto overflow-x-hidden w-full">
                <div className="py-8 px-4">
                    ...
                    {products.length > 0 ? (
                        <div className="flex flex-wrap gap-8 items-around">
